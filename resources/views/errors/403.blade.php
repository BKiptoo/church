...
<div class="container-xxl container-p-y">
    <div class="misc-wrapper">
        <div class="mt-3">
            <img src="{{ asset('assets/img/illustrations/403.png') }}" alt="page-misc-error-light"
                 width="500" class="img-fluid">
        </div>
        <br>
        <a href="{{ route('home') }}" class="btn btn-outline-danger"><span class="bx bx-left-arrow"></span> Back to home</a>
    </div>
</div>
<!-- Core JS -->
