<div>
    ...
    <div class="container-xxl flex-grow-1 container-p-y" wire:init="loadData">
        ...
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Edit/</span> Update Tender</h4>
            ...
            <div class="col-xl-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><a href="{{ route('list.tenders') }}"
                                            class="btn btn-link"><span
                                    class="bx bx-left-arrow"></span></a> Edit {{ $model->name }}</h5>
                        <small class="text-muted float-end">Update Tender</small>
                    </div>
                    <div class="card-body">
                        <form wire:submit.prevent="submit">
                            <div class="row">
                                ...
                                <div class="mb-3 col-6">
                                    <label class="form-label" for="name">Tender Name</label>
                                    <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                ...
                                <div class="mb-3 col-12">
                                    <label class="form-label" for="closingDate">Closing Date/Time</label>
                                    <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="bx bxs-calendar"></i></span>
                                        <input type="datetime-local" id="closingDate"
                                               class="form-control @error('closingDate') is-invalid @enderror"
                                               required
                                               name="closingDate" placeholder="Select closing date..."
                                               wire:model="closingDate"
                                               aria-describedby="closingDate"/>
                                        @error('closingDate')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="mb-3 col-12">
                                    <label class="form-label" for="tenderFiles">Tender Documents <i
                                            class="text-info"><b>optional</b></i></label>
                                    <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="bx bxs-image-add"></i></span>
                                        <input type="file" id="tenderFiles"
                                               class="form-control @error('tenderFiles') is-invalid @enderror"
                                               name="tenderFiles" placeholder="Tender documents" multiple
                                               wire:model="tenderFiles"
                                               aria-describedby="tenderFiles"/>
                                        @error('tenderFiles')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div wire:loading wire:target="tenderFiles"><span
