<div>
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Tenders /</span> List
        </h4>
        ...
        <div class="card" wire:poll.60000ms.visible>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-2">
                        <a href="{{ route('add.tender') }}" class="btn btn-outline-primary"><span
                                class="bx bx-plus"></span>Add Tender</a>
                    </div>
                </div>
            </div>
                ...
                @if(count($models))
                    <table class="table table-hover">
                        ...
                        @foreach($models as $model)
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="{{ route('edit.tender',['slug'=>$model->slug]) }}"><i
                                                    class="bx bx-edit-alt me-1"></i> Edit</a>
                                            <a class="dropdown-item"
                                               href="javascript:void(0);" data-bs-toggle="modal"
                                               data-bs-target="#cs-{{ $model->id }}"><i
                                                    class="bx bx-images me-1"></i> Files</a>
                            ...
                            <livewire:user.modal.tender-files :model="$model" :wire:key="$model->id">
                        @endforeach
                        </tbody>
                    </table>
