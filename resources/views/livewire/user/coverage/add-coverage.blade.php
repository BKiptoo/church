<div>
    ...
    <div class="container-xxl flex-grow-1 container-p-y" wire:init="loadData">
        ...
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Add/</span> Add Coverage</h4>
            ...
            <div class="col-xl-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">New Coverage</h5>
                        <small class="text-muted float-end">New Coverage</small>
                    </div>
                    <div class="card-body">
