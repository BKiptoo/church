<div>
    ...
    <div class="container-xxl flex-grow-1 container-p-y" wire:init="loadData">
        ...
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Edit/</span> Update Sub Category</h4>
            ...
            <div class="col-xl-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><a href="{{ route('list.sub.categories') }}"
                                            class="btn btn-link"><span
                                    class="bx bx-left-arrow"></span></a> Edit {{ $model->name }}</h5>
                        <small class="text-muted float-end">Update Sub Category</small>
                    </div>
                    <div class="card-body">
                        <form wire:submit.prevent="submit">
                            <div class="row">
                                ...
                                <div class="mb-3 col-12">
                                    <label class="form-label" for="photo">Category Banner <i class="text-info"><b>optional</b></i></label>
                                    <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
