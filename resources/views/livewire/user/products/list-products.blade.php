        ...
        <div class="card" wire:poll.6000ms.visible>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-3">
                        <a href="{{ route('add.product') }}" class="btn btn-outline-primary"><span
                                class="bx bx-plus"></span>Add Product</a>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($models as $model)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('list.orders') }}" class="btn btn-outline-primary"><span
                                            class="bx bx-cart"></span> {{ number_format(count($model->orders)) }}
                                    </a>
                                </td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="{{ route('edit.product',['slug'=>$model->slug]) }}"><i
