<div>
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Impact /</span> List
        </h4>
        ...
        <div class="card" wire:poll.6000ms.visible>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-3">
                        <a href="{{ route('add.impact') }}" class="btn btn-outline-primary"><span
                                class="bx bx-plus"></span>Add Impact</a>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="{{ route('edit.impact',['slug'=>$model->slug]) }}"><i
