<div>
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Ads /</span> List
        </h4>
        ...
        <div class="card" wire:poll.6000ms.visible>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-2">
                        <a href="{{ route('add.ad') }}" class="btn btn-outline-primary"><span
                                class="bx bx-plus"></span>Add Ad</a>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($models as $model)
                            <tr>
                                ...
                                <td>{{ $model->name }}</td>
                                <td>
                                    <a href="{{ $model->linkUrl }}" target="_blank" class="btn btn-link"><span
