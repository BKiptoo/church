<div>
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Offices /</span> List
        </h4>
        ...
        <div class="card" wire:poll.visible>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-2">
                        <a href="{{ route('add.office') }}" class="btn btn-outline-primary"><span
                                class="bx bx-plus"></span>Add Office</a>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="{{ route('edit.office',['slug'=>$model->slug]) }}"><i
