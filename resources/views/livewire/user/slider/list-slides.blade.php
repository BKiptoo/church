<div>
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Slides /</span> List
        </h4>
        ...
        <div class="card" wire:poll.visible>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-2">
                        <a href="{{ route('add.slide') }}" class="btn btn-outline-primary"><span
                                class="bx bx-plus"></span>Add Slide</a>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($models as $model)
                            <tr>
                                ...
                                <td>{{ $model->buttonName }}</td>
                                <td>
                                    <a href="{{ $model->buttonUrl }}" target="_blank" class="btn btn-link"><span
                                            class="bx bx-link-alt"></span></a>
                                </td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="{{ route('edit.slide',['id'=>$model->id]) }}"><i
