<div>
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Esg Reports /</span> List
        </h4>
        ...
        <div class="card" wire:poll.60000ms.visible>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-2">
                        <a href="{{ route('add.esg.report') }}" class="btn btn-outline-primary"><span
                                class="bx bx-plus"></span>Add Esg Report</a>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($models as $model)
                            <tr>
                                ...
                                <td>{{ $model->name }}</td>
                                <td>{!! \Illuminate\Support\Str::limit($model->description) !!}</td>
                                <td>
                                    <button wire:click="download('{{ $model->media->pathNames[0] }}')"
                                       class="btn btn-link"><span
                                            class="bx bx-download"></span></button>
                                </td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="{{ route('edit.esg.report',['slug'=>$model->slug]) }}"><i
