...
!function () {
    ...
    var o = window.document, e = o.location, t = window.Math, r = window.HTMLElement, a = window.XMLHttpRequest,
        ...
        s = d && r && "attachShadow" in r.prototype && !("prototype" in r.prototype.attachShadow), u = function (o, e) {
            ...
            if (!(t.push(e) > 1)) {
                ...
                if (d) {
                    ...
                    v(c, "load", l), v(c, "error", l), x(c, /de|m/, l), i.document.getElementsByTagName("head")[0].appendChild(c)
                }
            }
        }, _ = function (o, e, t) {
            var r = h(o.ownerDocument), a = o.appendChild(r("style", {type: "text/css"})),
            ...
            if (((u === c || u === "gist." + c) && "archive" === f[3] || u === c && "releases" === f[3] && ("download" === f[4] || "latest" === f[4] && "download" === f[5]) || u === "codeload." + c) && (d.target = "_top"), "true" === p(e["data-show-count"]) && u === c && "marketplace" !== f[1] && "sponsors" !== f[1] && "orgs" !== f[1] && "users" !== f[1] && "-" !== f[1]) {
                var g, v;
                if (!f[2] && f[1]) v = "followers", g = "?tab=followers"; else if (!f[3] && f[2]) v = "stargazers_count", g = "/stargazers"; else if (f[4] || "subscription" !== f[3]) if (f[4] || "fork" !== f[3]) {
                    if ("issues" !== f[3]) return void t(s);
                    v = "open_issues_count", g = "/issues"
                } else v = "forks_count", g = "/network/members"; else v = "subscribers_count", g = "/watchers";
        ...
        }, E = window.devicePixelRatio || 1, G = function (o) {
            ...
            if (null != e && null != r) if (e.getAttribute && (e = function (o) {
                ...
                var c = function () {
                    ...
                    w(n, "load", c), _.call(l, a, e, (function (o) {
                        var a = function (o) {
    ...
    e.protocol + "//" + e.host + e.pathname === i ? _(o.body, m(window.name || e.hash.replace(/^#/, "")), (function () {
    })) : function (e) {
